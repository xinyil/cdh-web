...
from aggregatedfeed.feeds import CombinedRecentFeed
from redirectviews.views import BlogSlugRedirectView
...
urlpatterns += [
    # Hard redirect urls from redirectviews
    url('^', include('redirectviews.urls')),
