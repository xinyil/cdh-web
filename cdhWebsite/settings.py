...
SEARCH_MODEL_CHOICES = ('pages.Page', 'blog.Blogpost', 'eventspages.EventPage',
                        'eventspages.EventsLandingPage', 'stocktemplate.StockLandingPage',
                        'staffprofiles.StaffLandingPage', 'projectpages.ProjectPage',
                        'projectpages.ProjectsLandingPage',)
...
ALLOWED_HOSTS = ['cdh-web.princeton.edu','digitalhumanities.princeton.edu']
